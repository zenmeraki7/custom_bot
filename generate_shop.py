...
# # ══════════════════════════════════════════════════════════════════════════════
# _OLLAMA_AVAILABLE = ollama_client.is_up()
...
#             return False
#     if use_ollama and _OLLAMA_AVAILABLE and items:
#         sample = [it.get("name", "") for it in items[:20]]
#         reply  = call_ollama(
...
#     if use_ollama and _OLLAMA_AVAILABLE and len(full_cats) > 4:
#         sample = [it.get("name", "") for it in items[:20]]
#         reply  = call_ollama(
...
#     use_ollama = use_ollama and _OLLAMA_AVAILABLE
