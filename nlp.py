...
#         return True
#     t = text.lower()
#     # Word-boundary check for very short particles ("nte", "und", "aanu")
#     _words = set(t.split())
...
#     "namaskaram", "sugano",
#     # "namskaram" — shortened spelling variant (missing the "a" between
#     # "nam" and "skar"), genuinely not a substring of "namaskaram" above.
#     "namskaram", "namskar",
#     # "ivde"/"enthoke" — "ivde specials enthoke und" was classified English → RAG in English
#     "ivde", "ividey", "ivideyund",
#     "enthoke", "enthokke", "enthokkund",
