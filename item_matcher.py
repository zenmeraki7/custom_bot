"""
item_matcher.py — Shop item lookup for any shop type  v2.1
==========================================================
...
v2.1 fix:
  - _BROAD_QUERY_PATTERNS is now imported from broad_query_patterns.py
    (single source of truth shared with chat.py / faq_engine.py) instead
    of a locally hardcoded list. The local copy never had a "medicines"-
    shaped phrase, so "medicines enthoke und" wasn't recognised as a
    broad catalog ask and fell through into a narrow, wrong FAQ instead.
"""
